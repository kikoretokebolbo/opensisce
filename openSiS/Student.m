...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *std_id= [[array_studentData objectAtIndex:indexPath.row] objectForKey:@"STUDENT_ID"];
    NSString *std_name=[[array_studentData objectAtIndex:indexPath.row] objectForKey:@"FULL_NAME"];
    NSUserDefaults *df=[NSUserDefaults standardUserDefaults];
