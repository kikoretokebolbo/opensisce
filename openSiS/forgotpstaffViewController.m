...
@interface forgotpstaffViewController ()
...
@implementation forgotpstaffViewController
@synthesize pr;
- (void)viewDidLoad {
    [super viewDidLoad];
    [self selectprofile];
...

{
    ...
    else if ([str_txt isEqualToString:@"parent"])
    {
        ...
        forgotpViewController *obj=[s instantiateViewControllerWithIdentifier:@"forgotpparent"];
